          ...
          <div className="flex lg:flex-1">
            <a href="/" className="-m-1.5 p-1.5">
              ...
              <Image
                height={32}
                width={32}
                className="h-8 w-auto scale-[3.5] ml-4"
                src="next.svg"
                alt=""
              />
            </a>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-12 lg:py-24">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              xSUI is a liquid staking solution built on SUI. Stake your SUI and
              get xSUI.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a className="text-sm font-semibold leading-6 text-gray-700 bg-gray-200 p-2 rounded-[25px] ">
                <span aria-hidden="true"></span> Currently in Testnet
              </a>
            </div>
          </div>
        </div>
